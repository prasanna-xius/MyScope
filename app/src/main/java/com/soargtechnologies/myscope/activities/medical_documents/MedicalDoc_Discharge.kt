...
class MedicalDoc_Discharge : BaseActivity() {
    var file: File? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_medical_doc__discharge)
        sharedpreferences = getSharedPreferences("MyPref", Context.MODE_PRIVATE);
        p_uploadid = sharedpreferences.getInt("dischargeid", 0)
...
//        }
        ...
        val fab = findViewById<View>(R.id.fab_dischargedocs) as FloatingActionButton
    ...
    private fun loadDestinations() {
        ...
        val requestCall = service.getDischargeDetails("8142529582")
    ...
    private fun uploadImage(imageBytes: ByteArray, code: Int) {
        ...
        if (codevalue.equals(102)) {
            ...
            body = MultipartBody.Part.createFormData("document_discharge_file", "Rx", requestFile)
            ...
            body = MultipartBody.Part.createFormData("document_discharge_file", "image.jpg", requestFile)
            type = RequestBody.create(MediaType.parse("text/plain"), "image")

        }
        val call = destinationService.uploaddocDischarge( mobile,body, date,type)
