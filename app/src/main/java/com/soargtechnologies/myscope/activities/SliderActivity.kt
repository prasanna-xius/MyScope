...
class SliderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layouts = intArrayOf(R.layout.slider_one, R.layout.slider_two, R.layout.slider_three,R.layout.slider_four,R.layout.slider_five)
    ...
    private fun launchHomeScreen() {
        ...
        startActivity(Intent(this@SliderActivity, Login_Page::class.java))
        finish()
    }
