...
class MedicalDoc_Education: BaseActivity() {
    ...
    var DocAdapter: Document_EducationAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        doceducation.setProgressBackgroundColorSchemeColor(ContextCompat.getColor(this, R.color.colorPrimary))
        doceducation.setColorSchemeColors(Color.WHITE)
        doceducation.setOnRefreshListener {
            ...
            doceducation.setRefreshing(false);
    ...
    private fun loadDestinations() {
        ...
        val requestCall = service.getEducationDetails(mobile_no)
            ...
            override fun onResponse(call: Call<MutableList<PrescriptionDataClass>>, response: Response<MutableList<PrescriptionDataClass>>) {
                if (response.isSuccessful()) {
                    ...
                    val imageList = response.body()!!
                     DocAdapter= Document_EducationAdapter(imageList)
