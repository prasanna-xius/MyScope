...
class Self_Monitering_Home_Page : BaseActivity() {
    ...
    var names = arrayOf("Blood Glucose", "Blood Pressure", "Cholestrol", "Bmi", "Exercise Tracker", "Emotional State")
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View { // TODO Auto-generated method stub
            ...
            rowView.setOnClickListener {
                ...
                if (position == 0) {
                    ...
                    navigateToActivity(Intent(applicationContext, Emotional_state::class.java))
                }
            }
            return rowView
        }
