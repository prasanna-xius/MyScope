...
class BmiAdaptor (private val bmiList: List<Self_dataClass>) : RecyclerView.Adapter<BmiAdaptor .ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BmiAdaptor.ViewHolder {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { v: View? ->
            ...
            intent.putExtra(CholestrolUpdate.ARG_ITEM_ID, holder.bmidestination!!.mobile_no)
