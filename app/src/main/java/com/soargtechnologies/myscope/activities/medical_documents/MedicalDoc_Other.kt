...
import com.soargtechnologies.myscope.helpers.Document_OtherAdapter
...
class MedicalDoc_Other: BaseActivity() {
    var file: File? = null
    private var mImageUrl = ""
    var p_uploadid: Int = 0
    var recyclerView: RecyclerView? = null
    var DocAdapter: Document_OtherAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_medical_doc__other)
        sharedpreferences = getSharedPreferences("MyPref", Context.MODE_PRIVATE);
        p_uploadid = sharedpreferences.getInt("otherid", 0)
        mobile_no = sharedpreferences!!.getString("mobile_no",null)!!

        recyclerView = findViewById(R.id.other_recycler_view)
        ...
        val fab = findViewById<View>(R.id.fab_otherdocs) as FloatingActionButton
    ...
    private fun loadDestinations() {
        ...
        val requestCall = service.getOtherDetails("8142529582")
            ...
            override fun onResponse(call: Call<MutableList<PrescriptionDataClass>>, response: Response<MutableList<PrescriptionDataClass>>) {
                if (response.isSuccessful()) {
                    ...
                    val imageList = response.body()!!
                     DocAdapter= Document_OtherAdapter(imageList)
                    recyclerView!!.adapter = DocAdapter
                    other_recycler_view.adapter?.notifyDataSetChanged()
    ...
    private fun uploadImage(imageBytes: ByteArray, code: Int) {
        ...
        if (codevalue.equals(102)) {
            ...
            body = MultipartBody.Part.createFormData("document_other_file", "Rx", requestFile)
            ...
            body = MultipartBody.Part.createFormData("document_other_file", "image.jpg", requestFile)
            type = RequestBody.create(MediaType.parse("text/plain"), "image")

        }
        val call = destinationService.uploaddocOther( mobile,body, date,type)
