...
class Lab_Blood_ImageAdapter(private val imglist: MutableList<Lab_ReportDataClass>): RecyclerView.Adapter<Lab_Blood_ImageAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       // holder.imageDetails = imglist[position]
        holder.savedDate.text = imglist[position].lab_blood_saved
        val imgls = imglist[position]
        id = imgls.lab_blood_id
        ...
        holder.uploadsno.text = imgls.lab_blood_id.toString()
        ...
        holder.deletebutton.setOnClickListener { v: View? ->
            ...
            val pref = context!!.getSharedPreferences("MyPref", Context.MODE_PRIVATE) // 0 - for private mode
            val editor: SharedPreferences.Editor = pref.edit()
            editor.putInt("uploadid", imglist[position].lab_blood_id!!)
            editor.commit()
            ...
            builder.setPositiveButton("Yes") { dialogInterface, which ->
                ...
                body.lab_blood_id = imglist[position].lab_blood_id!!
                ...
                val requestCall = deleteService.deleteBloodDetails(body)
