...
import kotlinx.android.synthetic.main.activity_medical_doc__health.view.*
import kotlinx.android.synthetic.main.list_doc_discharge.view.*
import kotlinx.android.synthetic.main.list_doc_health.view.*
...
class Document_HealthAdapter(private val imglist: MutableList<PrescriptionDataClass>): RecyclerView.Adapter<Document_HealthAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: Document_HealthAdapter.ViewHolder, position: Int) {
        ...
        id = imgls.document_insurance_id
        ...
        holder.uploadsno.text = imgls.document_insurance_id.toString()

        if (imgls.document_insurance_type.equals("image")) {
            Glide.with(holder.itemView.context)
                    .load(decodedBytes)
                    .into(holder.itemview.health_img)
        ...
        holder.imageView.setOnClickListener { v: View? ->
            ...
            if (imgls.document_insurance_type.equals("pdf")) {
        ...
        holder.deletebutton.setOnClickListener { v: View? ->
            ...
            val pref = context!!.getSharedPreferences("MyPref", Context.MODE_PRIVATE) // 0 - for private mode
            val editor: SharedPreferences.Editor = pref.edit()
            editor.putInt("insuranceid", imglist[position].document_insurance_id!!)
            editor.commit()
            ...
            builder.setPositiveButton("Yes") { dialogInterface, which ->
                ...
                body.document_insurance_id = imglist[position].document_insurance_id!!
                ...
                val requestCall = deleteService.deleteInsuranceDetails(body)
...
//                         Your status code is in the range of 300's, 400's and 500's
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.list_doc_health, parent, false)
    ...
    class ViewHolder(val itemview: View) : RecyclerView.ViewHolder(itemview) {
        ...
        val deletebutton: ImageView = itemview.findViewById(R.id.dochealthdlt)
        val imageView: ImageView = itemview.findViewById(R.id.health_img)
        val savedDate: TextView = itemView.findViewById(R.id.healthdate)
        var imageDetails: PrescriptionDataClass? = null
        var uploadsno: TextView = itemview.findViewById(R.id.healthid)
    }
