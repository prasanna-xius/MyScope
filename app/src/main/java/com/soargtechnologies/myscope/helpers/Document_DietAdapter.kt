...
import kotlinx.android.synthetic.main.list_doc_dental.view.*
import kotlinx.android.synthetic.main.list_doc_diet.view.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class Document_DietAdapter (private val imglist: MutableList<PrescriptionDataClass>): RecyclerView.Adapter<Document_DietAdapter.ViewHolder>() {


    @ExperimentalStdlibApi
    override fun onBindViewHolder(holder: Document_DietAdapter.ViewHolder, position: Int) {
        holder.imageDetails = imglist[position]
        holder.savedDate.text = imglist[position].document_diet_saved_on
        ...
        holder.uploadsno.text = imgls.document_diet_id.toString()

        if (imgls.document_diet_type.equals("image")) {
            Glide.with(holder.itemView.context)
                    .load(decodedBytes)
                    .into(holder.itemview.diet_img)
        ...
        holder.imageView.setOnClickListener { v: View? ->
            ...
            if (imgls.document_diet_type.equals("pdf")) {
            ...
            if (imgls.document_dental_type.equals("image")) {
        ...
        holder.deletebutton.setOnClickListener { v: View? ->
            ...
            val pref = context!!.getSharedPreferences("MyPref", Context.MODE_PRIVATE) // 0 - for private mode
            val editor: SharedPreferences.Editor = pref.edit()
            editor.putInt("dietid", imglist[position].document_diet_id!!)
            editor.commit()
            ...
            builder.setPositiveButton("Yes") { dialogInterface, which ->
                ...
                body.document_diet_id = imglist[position].document_diet_id!!
                ...
                val requestCall = deleteService.deleteDietDetails(body)
...
//                         Your status code is in the range of 300's, 400's and 500's
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.list_doc_diet, parent, false)
    ...
    class ViewHolder(val itemview: View) : RecyclerView.ViewHolder(itemview) {
        ...
        val deletebutton: ImageView = itemview.findViewById(R.id.docdietdlt)
        val imageView: ImageView = itemview.findViewById(R.id.diet_img)
        val savedDate: TextView = itemView.findViewById(R.id.dietdate)
        var imageDetails: PrescriptionDataClass? = null
        var uploadsno: TextView = itemview.findViewById(R.id.dietid)
    }
