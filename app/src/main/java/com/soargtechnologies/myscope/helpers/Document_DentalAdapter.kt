...
class Document_DentalAdapter(private val imglist: MutableList<PrescriptionDataClass>): RecyclerView.Adapter<Document_DentalAdapter.ViewHolder>() {


    @ExperimentalStdlibApi
    override fun onBindViewHolder(holder: Document_DentalAdapter.ViewHolder, position: Int) {
        holder.imageDetails = imglist[position]
        holder.savedDate.text = imglist[position].document_dental_saved_on
        val imgls = imglist[position]
        id = imgls.document_dental_id
        ...
        holder.uploadsno.text = imgls.document_dental_id.toString()

        if (imgls.document_dental_type.equals("image")) {
            Glide.with(holder.itemView.context)
                    .load(decodedBytes)
                    .into(holder.itemview.dental_img)
        ...
        holder.imageView.setOnClickListener { v: View? ->
            ...
            if (imgls.document_dental_type.equals("pdf")) {
        ...
        holder.deletebutton.setOnClickListener { v: View? ->
            ...
            val pref = context!!.getSharedPreferences("MyPref", Context.MODE_PRIVATE) // 0 - for private mode
            val editor: SharedPreferences.Editor = pref.edit()
            editor.putInt("dentalid", imglist[position].document_dental_id!!)
            editor.commit()
            ...
            builder.setPositiveButton("Yes") { dialogInterface, which ->
                ...
                body.document_dental_id = imglist[position].document_dental_id!!
                ...
                val requestCall = deleteService.deleteDentalDetails(body)
...
//                         Your status code is in the range of 300's, 400's and 500's
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.list_doc_dental, parent, false)
    ...
    class ViewHolder(val itemview: View) : RecyclerView.ViewHolder(itemview) {
        ...
        val deletebutton: ImageView = itemview.findViewById(R.id.dentaldlt)
        val imageView: ImageView = itemview.findViewById(R.id.dental_img)
        val savedDate: TextView = itemView.findViewById(R.id.dentaldate)
        var imageDetails: PrescriptionDataClass? = null
        var uploadsno: TextView = itemview.findViewById(R.id.dentalid)
    }
