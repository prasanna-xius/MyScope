...
class Lab_Ecg_ImageAdapter(private val imglist: MutableList<Lab_ReportDataClass>): RecyclerView.Adapter<Lab_Ecg_ImageAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       // holder.imageDetails = imglist[position]
        holder.savedDate.text = imglist[position].lab_ecg_saved
        ...
        holder.uploadsno.text = imgls.lab_ecg_id.toString()

        if (imgls.lab_ecg_type.equals("image")) {
        ...
        holder.imageView.setOnClickListener { v: View? ->
            ...
            if (imgls.lab_ecg_type.equals("pdf")) {
        ...
        holder.deletebutton.setOnClickListener { v: View? ->
            ...
            val pref = context!!.getSharedPreferences("MyPref", Context.MODE_PRIVATE) // 0 - for private mode
            val editor: SharedPreferences.Editor = pref.edit()
            editor.putInt("uploadid", imglist[position].lab_ecg_id!!)
            editor.commit()
            ...
            builder.setPositiveButton("Yes") { dialogInterface, which ->
                ...
                body.lab_ecg_id = imglist[position].lab_ecg_id!!
                ...
                val requestCall = deleteService.deleteEcgDetails(body)
