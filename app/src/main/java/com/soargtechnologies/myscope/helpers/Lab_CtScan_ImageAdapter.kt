...
class Lab_CtScan_ImageAdapter(private val imglist: MutableList<Lab_ReportDataClass>): RecyclerView.Adapter<Lab_CtScan_ImageAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       // holder.imageDetails = imglist[position]
        holder.savedDate.text = imglist[position].lab_ctscan_saved
        val imgls = imglist[position]
        id = imgls.lab_ctscan_id
        ...
        holder.uploadsno.text = imgls.lab_ctscan_id.toString()

        if (imgls.lab_ctscan_type.equals("image")) {
        ...
        holder.imageView.setOnClickListener { v: View? ->
            ...
            if (imgls.lab_ctscan_type.equals("pdf")) {
        ...
        holder.deletebutton.setOnClickListener { v: View? ->
            ...
            val pref = context!!.getSharedPreferences("MyPref", Context.MODE_PRIVATE) // 0 - for private mode
            val editor: SharedPreferences.Editor = pref.edit()
            editor.putInt("uploadid", imglist[position].lab_ctscan_id!!)
            editor.commit()
            ...
            builder.setPositiveButton("Yes") { dialogInterface, which ->
                ...
                body.lab_ctscan_id = imglist[position].lab_ctscan_id!!
                ...
                val requestCall = deleteService.deleteCtscanDetails(body)
