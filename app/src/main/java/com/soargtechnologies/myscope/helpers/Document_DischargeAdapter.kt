...
class Document_DischargeAdapter(private val imglist: MutableList<PrescriptionDataClass>): RecyclerView.Adapter<Document_DischargeAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: Document_DischargeAdapter.ViewHolder, position: Int) {
        ...
        id = imgls.document_discharge_id
        ...
        holder.uploadsno.text = imgls.document_discharge_id.toString()

        if (imgls.document_discharge_type.equals("image")) {
            Glide.with(holder.itemView.context)
                    .load(decodedBytes)
                    .into(holder.itemview.discharge_img)
        ...
        holder.imageView.setOnClickListener { v: View? ->
            ...
            if (imgls.document_discharge_type.equals("pdf")) {
        ...
        holder.deletebutton.setOnClickListener { v: View? ->
            ...
            val pref = context!!.getSharedPreferences("MyPref", Context.MODE_PRIVATE) // 0 - for private mode
            val editor: SharedPreferences.Editor = pref.edit()
            editor.putInt("dischargeid", imglist[position].document_discharge_id!!)
            editor.commit()
            ...
            builder.setPositiveButton("Yes") { dialogInterface, which ->
                ...
                body.document_discharge_id = imglist[position].document_discharge_id!!
                ...
                val requestCall = deleteService.deleteDischargeDetails(body)
...
//                         Your status code is in the range of 300's, 400's and 500's
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.list_doc_discharge, parent, false)
    ...
    class ViewHolder(val itemview: View) : RecyclerView.ViewHolder(itemview) {
        ...
        val deletebutton: ImageView = itemview.findViewById(R.id.docdischargedlt)
        val imageView: ImageView = itemview.findViewById(R.id.discharge_img)
        val savedDate: TextView = itemView.findViewById(R.id.idischargedate)
        var imageDetails: PrescriptionDataClass? = null
        var uploadsno: TextView = itemview.findViewById(R.id.dischargeid)
    }
