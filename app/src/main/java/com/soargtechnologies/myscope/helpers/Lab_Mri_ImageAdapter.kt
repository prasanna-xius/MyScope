...
class Lab_Mri_ImageAdapter(private val imglist: MutableList<Lab_ReportDataClass>): RecyclerView.Adapter<Lab_Mri_ImageAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       // holder.imageDetails = imglist[position]
        holder.savedDate.text = imglist[position].lab_mri_saved
        ...
        holder.uploadsno.text = imgls.lab_mri_id.toString()

        if (imgls.lab_mri_type.equals("image")) {
        ...
        holder.imageView.setOnClickListener { v: View? ->
            ...
            if (imgls.lab_mri_type.equals("pdf")) {
        ...
        holder.deletebutton.setOnClickListener { v: View? ->
            ...
            builder.setPositiveButton("Yes") { dialogInterface, which ->
                ...
                body.lab_mri_id = imglist[position].lab_mri_id!!
                ...
                val requestCall = deleteService.deleteMriDetails(body)
