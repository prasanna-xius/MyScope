...
class Lab_Urine_ImageAdapter(private val imglist: MutableList<Lab_ReportDataClass>): RecyclerView.Adapter<Lab_Urine_ImageAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       // holder.imageDetails = imglist[position]
        holder.savedDate.text = imglist[position].lab_urine_report_saved
        val imgls = imglist[position]
        id = imgls.lab_urine_report_id
        ...
        holder.uploadsno.text = imgls.lab_urine_report_id.toString()

        if (imgls.lab_urine_report_type.equals("image")) {
        ...
        holder.imageView.setOnClickListener { v: View? ->
            ...
            if (imgls.lab_urine_report_type.equals("pdf")) {
            ...
            if (imgls.lab_blood_type.equals("image")) {
        ...
        holder.deletebutton.setOnClickListener { v: View? ->
            ...
            val pref = context!!.getSharedPreferences("MyPref", Context.MODE_PRIVATE) // 0 - for private mode
            val editor: SharedPreferences.Editor = pref.edit()
            editor.putInt("uploadid", imglist[position].lab_urine_report_id!!)
            editor.commit()
            ...
            builder.setPositiveButton("Yes") { dialogInterface, which ->
                ...
                body.lab_urine_report_id = imglist[position].lab_urine_report_id!!
                ...
                val requestCall = deleteService.deleteUrineDetails(body)
