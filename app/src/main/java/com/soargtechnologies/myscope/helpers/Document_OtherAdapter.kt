...
import kotlinx.android.synthetic.main.list_doc_other.view.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class Document_OtherAdapter (private val imglist: MutableList<PrescriptionDataClass>): RecyclerView.Adapter<Document_OtherAdapter.ViewHolder>() {


    @ExperimentalStdlibApi
    override fun onBindViewHolder(holder: Document_OtherAdapter.ViewHolder, position: Int) {
        holder.imageDetails = imglist[position]
        holder.savedDate.text = imglist[position].document_other_saved_on
        val imgls = imglist[position]
        id = imgls.document_other_id
        ...
        holder.uploadsno.text = imgls.document_other_id.toString()

        if (imgls.document_other_type.equals("image")) {
            Glide.with(holder.itemView.context)
                    .load(decodedBytes)
                    .into(holder.itemview.other_img)
        ...
        holder.imageView.setOnClickListener { v: View? ->
            ...
            if (imgls.document_other_type.equals("pdf")) {
        ...
        holder.deletebutton.setOnClickListener { v: View? ->
            ...
            val pref = context!!.getSharedPreferences("MyPref", Context.MODE_PRIVATE) // 0 - for private mode
            val editor: SharedPreferences.Editor = pref.edit()
            editor.putInt("otherid", imglist[position].document_other_id!!)
            editor.commit()
            ...
            builder.setPositiveButton("Yes") { dialogInterface, which ->
                ...
                body.document_other_id = imglist[position].document_other_id!!
                ...
                val requestCall = deleteService.deleteOtherDetails(body)
...
//                         Your status code is in the range of 300's, 400's and 500's
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
                .inflate(R.layout.list_doc_other, parent, false)
    ...
    class ViewHolder(val itemview: View) : RecyclerView.ViewHolder(itemview) {
        ...
        val deletebutton: ImageView = itemview.findViewById(R.id.otherdlt)
        val imageView: ImageView = itemview.findViewById(R.id.other_img)
        val savedDate: TextView = itemView.findViewById(R.id.otherdate)
        var imageDetails: PrescriptionDataClass? = null
        var uploadsno: TextView = itemview.findViewById(R.id.otherid)
    }
